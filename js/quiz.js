...
function temizle() { // deneme div'inin içerisini temizlemek için hidden yapılarak gizlendi
    ...
    function quizBuild(){
        quiz[1] = new quizConstructor('Görselde bulunan bayrak hangi ülkenin bayrağıdır ','Birleşik Krallık',' ','Avustralya','İzlanda',1,"files/bayrak.png",false);
        quiz[2] = new quizConstructor('Videoda tanıtımı yapılan dizinin adı nedir ','Kırmızı Oda','Arka Sokaklar','Çukur','Kurtlar Vadisi',3,"",false,"files/Cukur.mp4");
        quiz[3] = new quizConstructor('Görselde bulunan yapı hangi ilçemizdedir ','Gürün','Divriği','Kangal','Hafik',2,"files/divrigi.jpg",false);
        quiz[4] = new quizConstructor('Videoda yer alan şarkıyı EuroVision sahnesinde söyleyen grup hangisidir ','Seksendört','Ayna','Model','Manga',4,"",false,"files/manga.mp4");
    ...
    function clearButton(){
        $("#option-1").css("background-color","aqua");
        $("#option-2").css("background-color","aqua");
        $("#option-3").css("background-color","aqua");
        $("#option-4").css("background-color","aqua");
    }
    ...
    function displayStats(){
        $(".stats").html("<h4>" +"Puan: "+correct +'/'+i+ '</h4>');
    }
